...
<template>
  <div class="animate-fade">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 lg:py-24">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div class="flex-1 space-y-8 text-center lg:text-left z-10 order-1 lg:order-1">
            ...
            <h1
              class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-[1.1] text-dark-red"
            >
              Rangkaian Bunga
            ...
            <p
              class="text-dark-red/60 max-w-lg leading-relaxed text-base lg:text-lg mx-auto lg:mx-0"
            >
    ...
    <section class="relative bg-cream py-20 overflow-hidden">
      ...
      <div
        class="absolute -bottom-32 -left-32 w-[400px] h-[400px] bg-maroon/20 rounded-full hidden lg:block"
      ></div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-10 text-center md:text-left">
          <div class="space-y-1">
            <p class="text-4xl md:text-5xl font-serif font-bold text-maroon">
              500<span class="text-3xl">+</span>
            </p>
            <p class="text-dark-red/50 text-sm font-medium">Desain Buket</p>
          </div>
          <div class="space-y-1">
            <p class="text-4xl md:text-5xl font-serif font-bold text-maroon">
              2.000<span class="text-3xl">+</span>
            </p>
            <p class="text-dark-red/50 text-sm font-medium">Pelanggan Puas</p>
          </div>
          <div class="space-y-1">
            <p class="text-4xl md:text-5xl font-serif font-bold text-maroon">
              5<span class="text-3xl">★</span>
            </p>
            <p class="text-dark-red/50 text-sm font-medium">Rating</p>
          </div>
          <div class="space-y-1">
            <p class="text-3xl md:text-4xl font-serif font-bold text-maroon leading-tight">
              Same<br />Day
            </p>
    ...
    <section class="bg-dark-red py-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 space-y-4">
          <div
            class="inline-flex items-center gap-2 text-maroon/60 text-xs font-black tracking-[0.2em] uppercase"
          >
            <span>✦</span> Untuk Setiap Momen
          </div>
          <h2 class="text-3xl md:text-5xl font-serif font-bold italic text-maroon tracking-tight">
            Buket untuk Semua Kesempatan
          </h2>
        </div>
    ...
    <section class="bg-cream py-24">
      <div class="max-w-3xl mx-auto px-4 text-center space-y-8">
        <div
          class="inline-flex items-center gap-2 text-dark-red/50 text-xs font-black tracking-[0.2em] uppercase"
        >
          <span>▲</span>
        </div>
        <h2 class="text-3xl md:text-5xl font-serif font-bold italic text-dark-red">
          Siap Memesan Buket Impianmu?
        </h2>
        <p class="text-dark-red/60 text-lg max-w-xl mx-auto">
