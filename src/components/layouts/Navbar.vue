    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        ...
        <a 
          ...
          class="hidden md:flex items-center gap-2 bg-cream text-white px-7 py-3 rounded-full font-bold text-sm hover:opacity-90 transition-opacity shadow-lg shadow-cream/20">
